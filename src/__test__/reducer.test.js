import infoReducer, { getInfo } from '../redux/country/country-slice';
import continentsReducer, { getContinents } from '../redux/home/home-slice';
import countriesReducer, { getCountries } from '../redux/region/region-slice';
...
describe('test list defined', () => {
  it('should home be defined', () => {
    const previousState = [];
    expect(continentsReducer(previousState, getContinents(0))).toBe(0);
  });
